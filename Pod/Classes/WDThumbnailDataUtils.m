...
#endif
        if (aError != NULL)
            *aError = [NSError errorWithDomain:WD_ASYNC_IMAGE_ERROR_DOMAIN code:-40 userInfo:nil];
        return NULL;
    }
...
#endif
        if (aError != NULL)
            *aError = [NSError errorWithDomain:WD_ASYNC_IMAGE_ERROR_DOMAIN code:-41 userInfo:nil];
        return NULL;
    }
